...
CONFIG_PATH = Path(f"{WORK_ROOT}/2026_sebastiao/projects/room_splatfacto/room_processed/splatfacto/FILL_TIMESTAMP/config.yml")
RESULTS_DIR = Path(f"{WORK_ROOT}/2026_sebastiao/projects/room_splatfacto/results_fim_all_frames")
OUTPUT_HTML = Path(f"{WORK_ROOT}/2026_sebastiao/projects/room_splatfacto/influence_viz_room.html")
...
<head>
<meta charset="utf-8">
<title>FIM Influence Visualization — Room</title>
<style>
